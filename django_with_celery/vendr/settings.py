...
DATABASES = {
    'default': {
        ...
        'NAME': 'vendr.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'iaw1y&k_z2_(0*uzb7*_!f7f29rkz=)*5&xnl2q-!*g*z(79_('
...
try:
    ...
    pass # ignore local setting import errors
